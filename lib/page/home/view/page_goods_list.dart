...
import 'package:flutterdemo/page/home/view/goods_item.dart';
import 'package:flutterdemo/page/home/been/goods_page_info.dart';
import 'package:flutterdemo/page/home/view/page_goods_list_skeleton.dart';

import 'package:pull_to_refresh/pull_to_refresh.dart';
import '../../../http/common_service.dart';
...
class _PageGoodsListState extends State<PageGoodsList> {
  ...
  queryGoodsListByPage(int currentPage) {
    CommonServiceApi.queryGoodsListByPage(widget.code, currentPage, 16).then((value) {
      if (value != null) {
        List<GoodsList> goods = goodsPageInfo.goodsList ?? [];
